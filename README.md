<h1 align="center">ostis-geometry</h1>

[![License](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

## Overview

`ostis-geometry` is a working example of an ostis-system, utilizing the [OSTIS Technology](https://github.com/ostis-ai).
...
2.  **Clone repository:**
    ...
    ```sh
    git clone https://github.com/ostis-apps/ostis-geometry.git
    cd ostis-geometry
...
1.  **Start `sc-machine` (in a terminal):**
    ...
    ./install/sc-machine/bin/sc-machine -s kb.bin \
        -e "install/sc-machine/lib/extensions;build/Release/extensions"
    ```
...
Contributions, issues, and feature requests are welcome! Check the [issues page](https://github.com/ostis-apps/ostis-geometry/issues).
